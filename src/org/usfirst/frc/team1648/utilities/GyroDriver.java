...
import edu.wpi.first.wpilibj.smartdashboard.SmartDashboard;
	...
	public class GyroDriver extends GyroBase implements Gyro, PIDSource, LiveWindowSendable {
	   ...
	   */
	  public GyroDriver(SPI.Port port) {
	    m_spi = new SPI(port);
	    ...
	    System.out.println("Register value: " + readRegister(kPIDRegister));
	    System.out.println("Register value: " + (readRegister(kPIDRegister) & 0xff00));
	    
	    if ((readRegister(kPIDRegister) & 0xff00) != 0x5201) {
	      m_spi.free();
	      m_spi = null;
	    ...
	    DriverStation.reportWarning("YOU DID IT!", false);
	    ...
	    LiveWindow.addSensor("GyroDriver", port.value, this);
	  }
